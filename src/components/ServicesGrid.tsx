...
function ServiceCard({ service }: { service: Service }) {
  return (
    <article className="group relative overflow-hidden rounded-[2rem] border border-line/15 bg-surface/70 p-7 shadow-luxury transition duration-500 hover:-translate-y-1 hover:border-gold/40">
